...
OUTPUT_FILE = "public/rexagames.json"
...
def download():
    print("=" * 58)
    print("  Descargador rexagames.json via FlareSolverr")
    print("=" * 58)
    print()
